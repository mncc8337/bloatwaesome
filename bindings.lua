...
globalkeys = gears.table.join(
    ...
    -- print screen
    awful.key({               }, "Print", function() awful.spawn.with_shell(awesome_dir.."scripts/screenshot full")      end,
              {description = "print full screen",               group = "media"}),
    awful.key({modkey         }, "Print", function() awful.spawn.with_shell(awesome_dir.."scripts/screenshot full save") end,
              {description = "print full screen and save",      group = "media"}),
    awful.key({        "Shift"}, "Print", function() awful.spawn.with_shell(awesome_dir.."scripts/screenshot area")      end,
              {description = "print a part of screen",          group = "media"}),
    awful.key({modkey, "Shift"}, "Print", function() awful.spawn.with_shell(awesome_dir.."scripts/screenshot area save") end,
